...
private:
	struct AnimatorStateMachineUiState { bool initialized = false; char initialStateName[64] = ""; char transitionFromState[64] = ""; char transitionToState[64] = ""; char transitionFilterFromState[64] = ""; char transitionFilterToState[64] = ""; float transitionBlendSeconds = 0.25f; bool addTransitionPopupInitialized = false; int editingTransitionIndex = -1; std::vector<AnimatorComponent::Condition> conditions; };
